...
@section('title', 'Edit Data Kelapa Sawit')

@section('header', 'Edit Data Produksi Kelapa Sawit')

@section('content')
<div class="container">
    <h1>Edit Data Produksi Kelapa Sawit</h1>
    ...
    <form action="{{ route('kopi.update', $kakao->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <a href="{{ route('kopi.index') }}" class="btn btn-secondary">Kembali</a>
    </form>
</div>
@endsection
