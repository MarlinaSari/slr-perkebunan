...
@section('title', 'Edit Data Kelapa')

@section('header', 'Edit Data Produksi Kelapa')

@section('content')
<div class="container">
    <h1>Edit Data Produksi Kelapa</h1>
    ...
    <form action="{{ route('kelapa.update', $kakao->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <a href="{{ route('kelapa.index') }}" class="btn btn-secondary">Kembali</a>
    </form>
</div>
@endsection
