...
@section('title', 'Edit Data Kakao')

@section('header', 'Edit Data Produksi Kakao')

@section('content')
<div class="container">
    <h1>Edit Data Produksi Kakao</h1>
    ...
    <form action="{{ route('kakao.update', $kakao->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <a href="{{ route('kakao.index') }}" class="btn btn-secondary">Kembali</a>
    </form>
</div>
@endsection
